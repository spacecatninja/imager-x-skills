...
| `references/transformers.md` | Per-transformer feature matrix and what each one silently drops, `transformerParams` escape hatch, per-transformer config and purging, storages and optimizers, choosing a transformer | 302 |
